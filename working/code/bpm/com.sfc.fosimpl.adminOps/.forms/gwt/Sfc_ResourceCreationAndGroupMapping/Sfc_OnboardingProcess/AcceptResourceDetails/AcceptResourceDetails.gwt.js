...
tibcoforms.formCode['_t9RoYO-BEeew6MIz6mWFYQ'] = new Object();
tibcoforms.formCode['_t9RoYO-BEeew6MIz6mWFYQ']['defineActions'] = function() {
var fc = tibcoforms.formCode['_t9RoYO-BEeew6MIz6mWFYQ'];
...
tibcoforms.formCode['_t9RoYO-BEeew6MIz6mWFYQ']['defineActions']();

tibcoforms.formCode['_t9RoYO-BEeew6MIz6mWFYQ']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_t9RoYO-BEeew6MIz6mWFYQ'];
...
fc['validation_ResouceEntry_input_ResouceEntry_input__multiplicity'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['register_pkgs_and_fcts'] = function(formId) {
	   var form = tibcoforms.formCache[formId];
	   form.registerPackages(['com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.xsd.XsdPackage']);
       form.registerFactories(['com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.xsd.XsdFactory']);
	}
...
tibcoforms.formCode['_t9RoYO-BEeew6MIz6mWFYQ']['defineValidations']();
