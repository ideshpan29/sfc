 ...
 * This provides an implementation of the class com.sfc.fosImpl.dataModel.ContractorGroups. 
 */ 


com.tibco.data.Loader.classDefiner["com.sfc.fosImpl.dataModel.ContractorGroups"] = function() {
...
theClass.getName = function() {
    return "com.sfc.fosImpl.dataModel.ContractorGroups";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.sfc.fosImpl.dataModel.ContractorGroups");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups");
};

theClass.prototype.getLoginName = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_LOGINNAME, useInternal);
};

theClass.prototype.setLoginName = function(loginName) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_LOGINNAME, loginName);
};


theClass.prototype.getFirstName = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_FIRSTNAME, useInternal);
};

theClass.prototype.setFirstName = function(firstName) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_FIRSTNAME, firstName);
};


theClass.prototype.getLastName = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_LASTNAME, useInternal);
};

theClass.prototype.setLastName = function(lastName) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_LASTNAME, lastName);
};


theClass.prototype.getContractorGroupName = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_CONTRACTORGROUPNAME, useInternal);
};

theClass.prototype.setContractorGroupName = function(contractorGroupName) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_CONTRACTORGROUPNAME, contractorGroupName);
};


theClass.prototype.getMasterUser = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_MASTERUSER, useInternal);
};

theClass.prototype.setMasterUser = function(masterUser) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_MASTERUSER, masterUser);
};


theClass.prototype.getEmailID = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_EMAILID, useInternal);
};

theClass.prototype.setEmailID = function(emailID) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.ContractorGroups").ATTR_EMAILID, emailID);
};
...
com.tibco.data.Loader.classDefiner["com.sfc.fosImpl.dataModel.ContractorGroups"]();
