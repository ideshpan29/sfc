...
tibcoforms.formCode['_8jvFsPXHEee0vPc65Z0SUQ'] = new Object();
tibcoforms.formCode['_8jvFsPXHEee0vPc65Z0SUQ']['defineActions'] = function() {
var fc = tibcoforms.formCode['_8jvFsPXHEee0vPc65Z0SUQ'];
	   ...
	   try {
	       ...
	       throw e;
			...
			fc['action_rule1'] = function(context, data, pane, control, factory, pkg, f , p) {
				...
				if(data.getTaskName()=="Deactivation Process Initiate") {
	   ...
	   try {
	       ...
	       throw e;
			...
			fc['action_rule11'] = function(context, data, pane, control, factory, pkg, f , p) {
				 ...
				 var resource = context.form.resource;
			     var logger = tibcoforms.bridge.log_logger();
				//data.setTaskName("Deactivation Process Initiate");
...
if(data.getTaskName()=="Select Contractor Agency"){
pane.pneMarginPaneCntrAgnt.setVisible(false);
pane.selectContractorAgency.setVisible(false);
...
if(data.getTaskName()=="Process Manager Review"){
	   ...
	   try {
	       ...
	       throw e;
			...
			fc['action_equipments'] = function(context, data, pane, control, factory, pkg, f , p) {
				 ...
				 var resource = context.form.resource;
			     var logger = tibcoforms.bridge.log_logger();
				var Record=factory.com_example_sfc_provisioningbom.createEquipmentDetails();
...
tibcoforms.formCode['_8jvFsPXHEee0vPc65Z0SUQ']['defineActions']();

tibcoforms.formCode['_8jvFsPXHEee0vPc65Z0SUQ']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_8jvFsPXHEee0vPc65Z0SUQ'];
...
tibcoforms.formCode['_8jvFsPXHEee0vPc65Z0SUQ']['defineValidations']();
