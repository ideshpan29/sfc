...
theClass.prototype.getLdapentryinput = function() {
    return this._getComplexAttribute(this.loader.getClass("com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.ldapentryType").ATTR_LDAPENTRYINPUT);
};
...
theClass.prototype.setLdapentryinput = function(ldapentryinput) {
    ...
    var attrRef = classRef.ATTR_LDAPENTRYINPUT;
    var attrType = classRef._getTypeDef(attrRef);
    if (eval("ldapentryinput instanceof this.loader.getClass(attrType.type)")) {
        this._setComplexAttribute(attrRef, ldapentryinput);
    } else {
