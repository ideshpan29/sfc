...
tibcoforms.formCode['_REkHsCXnEeiVIr-c0HRmlw'] = new Object();
tibcoforms.formCode['_REkHsCXnEeiVIr-c0HRmlw']['defineActions'] = function() {
var fc = tibcoforms.formCode['_REkHsCXnEeiVIr-c0HRmlw'];
	   ...
	   try {
	       ...
	       throw e;
			...
			fc['action_rule1'] = function(context, data, pane, control, factory, pkg, f , p) {
				 ...
				 var resource = context.form.resource;
			     var logger = tibcoforms.bridge.log_logger();
				data.setTaskName("Initiate_Activation_Process");
...
pane.TechnicalInfo.setVisible(false);
	   ...
	   try {
	       ...
	       throw e;
			...
			fc['action_rule11'] = function(context, data, pane, control, factory, pkg, f , p) {
				 ...
				 var resource = context.form.resource;
			     var logger = tibcoforms.bridge.log_logger();
				//data.setTaskName("PM_Track_Installation");
...
setupFontColor('[id$=lblSelectProjectManager]');
...
if(data.getProvisioning_Data().getSiebelCircuitID()=='90981'){
    ...
    data.getProvisioning_Data().setServiceType("WIMAX");
    ...
    fc['rule_updatePerformer'] = function(formId, context, thisObj) {
	   try {
			tibco.forms.Util.handleScriptAction.call(thisObj, formId, context, thisObj, "updatePerformer", "updatePerformer", fc['action_updatePerformer']);
	   } catch(e) {
	       tibcoforms.bridge.log_error("Rule(updatePerformer) Error: " + e);
	       throw e;
	   }
	}

			fc['action_updatePerformer'] = function(context, data, pane, control, factory, pkg, f , p) {
				 if (context.form && context.form._marked4Cancel)
					return;
				 var resource = context.form.resource;
			     var logger = tibcoforms.bridge.log_logger();
...
tibcoforms.formCode['_REkHsCXnEeiVIr-c0HRmlw']['defineActions']();

tibcoforms.formCode['_REkHsCXnEeiVIr-c0HRmlw']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_REkHsCXnEeiVIr-c0HRmlw'];
...
fc['validation_Provisioning_Data_buildingName_Provisioning_Data_buildingName__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getResourceList = function(useInternal) {
			return this.form.dataMap['resourceList'].getValue(useInternal);
		};
		this.setResourceList = function(value) {
			return this.form.dataMap['resourceList'].setValue(value);
		};
		...
		this.getActivationExecutionRequest = function() {
			return this.form.dataMap['ActivationExecutionRequest'].getValue();
		};
		this.setActivationExecutionRequest = function(value) {
			return this.form.dataMap['ActivationExecutionRequest'].setValue(value);
		};
		...
		this.setField2 = function(value) {
			return this.form.dataMap['Field2'].setValue(value);
		};
...
tibcoforms.formCode['_REkHsCXnEeiVIr-c0HRmlw']['defineValidations']();
