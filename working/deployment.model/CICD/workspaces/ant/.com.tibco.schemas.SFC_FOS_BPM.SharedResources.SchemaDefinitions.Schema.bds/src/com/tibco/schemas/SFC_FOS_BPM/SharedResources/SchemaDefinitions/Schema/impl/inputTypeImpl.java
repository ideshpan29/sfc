 ...
 * <ul>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.inputTypeImpl#getFirstname <em>Firstname</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.inputTypeImpl#getLastname <em>Lastname</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.inputTypeImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.inputTypeImpl#getPassword <em>Password</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.inputTypeImpl#getOrgmodelname <em>Orgmodelname</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.inputTypeImpl#getFlag <em>Flag</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.inputTypeImpl#getEntity <em>Entity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class inputTypeImpl extends EObjectImpl implements inputType
{
  ...
  {
    return SchemaPackage.Literals.INPUT_TYPE;
  }
  ...
  public void setFirstname(String newFirstname)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.INPUT_TYPE__FIRSTNAME, oldFirstname, firstname));
  }
  ...
  public void setLastname(String newLastname)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.INPUT_TYPE__LASTNAME, oldLastname, lastname));
  }
  ...
  public void setEmail(String newEmail)
  {
    ...
    email = newEmail;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.INPUT_TYPE__EMAIL, oldEmail, email));
  }
  ...
  public void setPassword(String newPassword)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.INPUT_TYPE__PASSWORD, oldPassword, password));
  }
  ...
  public void setOrgmodelname(String newOrgmodelname)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.INPUT_TYPE__ORGMODELNAME, oldOrgmodelname, orgmodelname));
  }
  ...
  public void setFlag(String newFlag)
  {
    ...
    flag = newFlag;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.INPUT_TYPE__FLAG, oldFlag, flag));
  }
  ...
  public void setEntity(String newEntity)
  {
    ...
    entity = newEntity;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.INPUT_TYPE__ENTITY, oldEntity, entity));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SchemaPackage.INPUT_TYPE__FIRSTNAME:
        return getFirstname();
      case SchemaPackage.INPUT_TYPE__LASTNAME:
        return getLastname();
      case SchemaPackage.INPUT_TYPE__EMAIL:
        return getEmail();
      case SchemaPackage.INPUT_TYPE__PASSWORD:
        return getPassword();
      case SchemaPackage.INPUT_TYPE__ORGMODELNAME:
        return getOrgmodelname();
      case SchemaPackage.INPUT_TYPE__FLAG:
        return getFlag();
      case SchemaPackage.INPUT_TYPE__ENTITY:
        return getEntity();
    }
