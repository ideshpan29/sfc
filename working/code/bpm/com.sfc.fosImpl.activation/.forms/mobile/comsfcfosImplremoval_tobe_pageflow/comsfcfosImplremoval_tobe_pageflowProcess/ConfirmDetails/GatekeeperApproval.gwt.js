...
tibcoforms.formCode['_Dd2GwDNCEeikWfQoT6A2pg'] = new Object();
tibcoforms.formCode['_Dd2GwDNCEeikWfQoT6A2pg']['defineActions'] = function() {
var fc = tibcoforms.formCode['_Dd2GwDNCEeikWfQoT6A2pg'];
...
pane.clientDetails01.setEnabled(true);
pane.installationAddress01.setEnabled(true);
pane.pane1.setEnabled(true);
pane.pane8.setEnabled(true);
pane.serviceRequest.setEnabled(true);
pane.contactDetails01.setEnabled(true);
pane.pneSrvcDtPane01.setEnabled(true);
pane.pneSrvcDtPane02.setEnabled(true);
pane.pneSrvcDt.setEnabled(true);
}
...
tibcoforms.formCode['_Dd2GwDNCEeikWfQoT6A2pg']['defineActions']();

tibcoforms.formCode['_Dd2GwDNCEeikWfQoT6A2pg']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_Dd2GwDNCEeikWfQoT6A2pg'];
...
tibcoforms.formCode['_Dd2GwDNCEeikWfQoT6A2pg']['defineValidations']();
