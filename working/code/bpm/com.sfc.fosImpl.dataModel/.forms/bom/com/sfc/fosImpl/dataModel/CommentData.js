 ...
 * This provides an implementation of the class com.sfc.fosImpl.dataModel.CommentData. 
 */ 


com.tibco.data.Loader.classDefiner["com.sfc.fosImpl.dataModel.CommentData"] = function() {
...
theClass.getName = function() {
    return "com.sfc.fosImpl.dataModel.CommentData";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.sfc.fosImpl.dataModel.CommentData");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.sfc.fosImpl.dataModel.CommentData");
};

theClass.prototype.getAddedby = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.CommentData").ATTR_ADDEDBY, useInternal);
};

theClass.prototype.setAddedby = function(addedby) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.CommentData").ATTR_ADDEDBY, addedby);
};


theClass.prototype.getComments = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.CommentData").ATTR_COMMENTS, useInternal);
};

theClass.prototype.setComments = function(comments) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.CommentData").ATTR_COMMENTS, comments);
};


theClass.prototype.getStepName = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.CommentData").ATTR_STEPNAME, useInternal);
};

theClass.prototype.setStepName = function(stepName) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.CommentData").ATTR_STEPNAME, stepName);
};


theClass.prototype.getTime = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.CommentData").ATTR_TIME, useInternal);
};

theClass.prototype.setTime = function(time) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.CommentData").ATTR_TIME, time);
};
...
com.tibco.data.Loader.classDefiner["com.sfc.fosImpl.dataModel.CommentData"]();
