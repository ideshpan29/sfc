...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>pi complete Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.pi_completeTypeImpl#getProcess_instance <em>Process instance</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.pi_completeTypeImpl#getCustomer_name <em>Customer name</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.pi_completeTypeImpl#getSibelcircuit_id <em>Sibelcircuit id</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.pi_completeTypeImpl#getProjectmanager <em>Projectmanager</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.pi_completeTypeImpl#getCur_activity <em>Cur activity</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.pi_completeTypeImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.impl.pi_completeTypeImpl#getExec_mills <em>Exec mills</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class pi_completeTypeImpl extends EObjectImpl implements pi_completeType
{
  /**
  ...
  {
    return SchemaPackage.Literals.PI_COMPLETE_TYPE;
  }
  ...
  public void setProcess_instance(String newProcess_instance)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.PI_COMPLETE_TYPE__PROCESS_INSTANCE, oldProcess_instance, process_instance));
  }
  ...
  public void setCustomer_name(String newCustomer_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.PI_COMPLETE_TYPE__CUSTOMER_NAME, oldCustomer_name, customer_name));
  }
  ...
  public void setSibelcircuit_id(String newSibelcircuit_id)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.PI_COMPLETE_TYPE__SIBELCIRCUIT_ID, oldSibelcircuit_id, sibelcircuit_id));
  }
  ...
  public void setProjectmanager(String newProjectmanager)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.PI_COMPLETE_TYPE__PROJECTMANAGER, oldProjectmanager, projectmanager));
  }
  ...
  public void setCur_activity(String newCur_activity)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.PI_COMPLETE_TYPE__CUR_ACTIVITY, oldCur_activity, cur_activity));
  }
  ...
  public void setStatus(String newStatus)
  {
    ...
    status = newStatus;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.PI_COMPLETE_TYPE__STATUS, oldStatus, status));
  }
  ...
  public void setExec_mills(String newExec_mills)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SchemaPackage.PI_COMPLETE_TYPE__EXEC_MILLS, oldExec_mills, exec_mills));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SchemaPackage.PI_COMPLETE_TYPE__PROCESS_INSTANCE:
        return getProcess_instance();
      case SchemaPackage.PI_COMPLETE_TYPE__CUSTOMER_NAME:
        return getCustomer_name();
      case SchemaPackage.PI_COMPLETE_TYPE__SIBELCIRCUIT_ID:
        return getSibelcircuit_id();
      case SchemaPackage.PI_COMPLETE_TYPE__PROJECTMANAGER:
        return getProjectmanager();
      case SchemaPackage.PI_COMPLETE_TYPE__CUR_ACTIVITY:
        return getCur_activity();
      case SchemaPackage.PI_COMPLETE_TYPE__STATUS:
        return getStatus();
      case SchemaPackage.PI_COMPLETE_TYPE__EXEC_MILLS:
