...
tibcoforms.formCode['_uus5MPtREeeupNwu8S8N4Q'] = new Object();
tibcoforms.formCode['_uus5MPtREeeupNwu8S8N4Q']['defineActions'] = function() {
var fc = tibcoforms.formCode['_uus5MPtREeeupNwu8S8N4Q'];
...
tibcoforms.formCode['_uus5MPtREeeupNwu8S8N4Q']['defineActions']();

tibcoforms.formCode['_uus5MPtREeeupNwu8S8N4Q']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_uus5MPtREeeupNwu8S8N4Q'];
...
fc['validation_BPMUsers_name_BPMUsers_name__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['register_pkgs_and_fcts'] = function(formId) {
	   var form = tibcoforms.formCache[formId];
	   form.registerPackages(['com.sfc.fosImpl.dataModel.DataModelPackage', 'com.sfc.fosImpl.adminOps.dataModel.DataModelPackage', 'com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.SchemaPackage']);
       form.registerFactories(['com.sfc.fosImpl.dataModel.DataModelFactory', 'com.sfc.fosImpl.adminOps.dataModel.DataModelFactory', 'com.tibco.schemas.SFC_FOS_BPM.SharedResources.SchemaDefinitions.Schema.SchemaFactory']);
	}
...
tibcoforms.formCode['_uus5MPtREeeupNwu8S8N4Q']['defineValidations']();
