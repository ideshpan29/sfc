 ...
 * This provides an implementation of the class com.sfc.fosImpl.dataModel.TechnicalInformation. 
 */ 

com.tibco.data.Loader.currentLoader.load("com.sfc.fosImpl.dataModel.EquipmentDetails");

com.tibco.data.Loader.classDefiner["com.sfc.fosImpl.dataModel.TechnicalInformation"] = function() {
...
theClass.getName = function() {
    return "com.sfc.fosImpl.dataModel.TechnicalInformation";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.sfc.fosImpl.dataModel.TechnicalInformation");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation");
};

theClass.prototype.getCarrierVLAN = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_CARRIERVLAN, useInternal);
};

theClass.prototype.setCarrierVLAN = function(carrierVLAN) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_CARRIERVLAN, carrierVLAN);
};


theClass.prototype.getCarrierIP = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_CARRIERIP, useInternal);
};

theClass.prototype.setCarrierIP = function(carrierIP) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_CARRIERIP, carrierIP);
};


theClass.prototype.getAggPoint = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_AGGPOINT, useInternal);
};

theClass.prototype.setAggPoint = function(aggPoint) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_AGGPOINT, aggPoint);
};


theClass.prototype.getPort = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_PORT, useInternal);
};

theClass.prototype.setPort = function(port) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_PORT, port);
};


theClass.prototype.getClientVLAN = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_CLIENTVLAN, useInternal);
};

theClass.prototype.setClientVLAN = function(clientVLAN) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_CLIENTVLAN, clientVLAN);
};


theClass.prototype.getClientIP = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_CLIENTIP, useInternal);
};

theClass.prototype.setClientIP = function(clientIP) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_CLIENTIP, clientIP);
};


theClass.prototype.getSFCPOPPE = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_SFCPOPPE, useInternal);
};

theClass.prototype.setSFCPOPPE = function(SFCPOPPE) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_SFCPOPPE, SFCPOPPE);
};


theClass.prototype.getPortType = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_PORTTYPE, useInternal);
};

theClass.prototype.setPortType = function(portType) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_PORTTYPE, portType);
};


theClass.prototype.getEquipment = function() {
    return this._getComplexArrayAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_EQUIPMENT);
};
...
theClass.prototype.getModifiedBy = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_MODIFIEDBY, useInternal);
};

theClass.prototype.setModifiedBy = function(modifiedBy) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_MODIFIEDBY, modifiedBy);
};


theClass.prototype.getModifiedDate = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_MODIFIEDDATE, useInternal);
};

theClass.prototype.setModifiedDate = function(modifiedDate) {
    this._setPrimitiveAttribute(this.loader.getClass("com.sfc.fosImpl.dataModel.TechnicalInformation").ATTR_MODIFIEDDATE, modifiedDate);
};
...
com.tibco.data.Loader.classDefiner["com.sfc.fosImpl.dataModel.TechnicalInformation"]();
