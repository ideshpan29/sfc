...
tibcoforms.formCode['_ZpT4sAZmEeiEUrigAi4Jdg'] = new Object();
tibcoforms.formCode['_ZpT4sAZmEeiEUrigAi4Jdg']['defineActions'] = function() {
var fc = tibcoforms.formCode['_ZpT4sAZmEeiEUrigAi4Jdg'];
...
tibcoforms.formCode['_ZpT4sAZmEeiEUrigAi4Jdg']['defineActions']();

tibcoforms.formCode['_ZpT4sAZmEeiEUrigAi4Jdg']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_ZpT4sAZmEeiEUrigAi4Jdg'];
...
fc['validation_ErrorDetail_ErrorDetail__length'] = function(formId, controlName, cloneUID, listIndex) {
	var valScr = 'typeof context.stringValue != \'undefined\' && typeof tibco.forms.Util != \'undefined\' ? tibco.forms.Util.checkTextLength(context.stringValue, 4000) ? true : [context.control.getLabel(), \'4000\'] : context.value.length <= 4000;';
...
tibcoforms.formCode['_ZpT4sAZmEeiEUrigAi4Jdg']['defineValidations']();
