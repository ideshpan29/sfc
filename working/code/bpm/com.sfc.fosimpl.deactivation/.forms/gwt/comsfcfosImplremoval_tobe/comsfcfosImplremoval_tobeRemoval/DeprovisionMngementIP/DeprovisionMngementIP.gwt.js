...
tibcoforms.formCode['_qPdJUPEiEeeJiLkPq4yokA'] = new Object();
tibcoforms.formCode['_qPdJUPEiEeeJiLkPq4yokA']['defineActions'] = function() {
var fc = tibcoforms.formCode['_qPdJUPEiEeeJiLkPq4yokA'];
...
tibcoforms.formCode['_qPdJUPEiEeeJiLkPq4yokA']['defineActions']();

tibcoforms.formCode['_qPdJUPEiEeeJiLkPq4yokA']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_qPdJUPEiEeeJiLkPq4yokA'];
...
fc['validation_Equipments_VLAN_Equipments_VLAN__length'] = function(formId, controlName, cloneUID, listIndex) {
	var valScr = 'typeof context.stringValue != \'undefined\' && typeof tibco.forms.Util != \'undefined\' ? tibco.forms.Util.checkTextLength(context.stringValue, 50) ? true : [context.control.getLabel(), \'50\'] : context.value.length <= 50;';
	// return tibco.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Equipments_VLAN: Equipments_VLAN__length", true, true);
	return tibco.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Equipments_VLAN__length", true, true);
}
...
fc['validation_Equipments_type_Equipments_type__length'] = function(formId, controlName, cloneUID, listIndex) {
	var valScr = 'typeof context.stringValue != \'undefined\' && typeof tibco.forms.Util != \'undefined\' ? tibco.forms.Util.checkTextLength(context.stringValue, 50) ? true : [context.control.getLabel(), \'50\'] : context.value.length <= 50;';
	// return tibco.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Equipments_type: Equipments_type__length", true, true);
	return tibco.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Equipments_type__length", true, true);
}
...
fc['validation_Equipments_address_Equipments_address__length'] = function(formId, controlName, cloneUID, listIndex) {
	var valScr = 'typeof context.stringValue != \'undefined\' && typeof tibco.forms.Util != \'undefined\' ? tibco.forms.Util.checkTextLength(context.stringValue, 50) ? true : [context.control.getLabel(), \'50\'] : context.value.length <= 50;';
	// return tibco.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Equipments_address: Equipments_address__length", true, true);
	return tibco.forms.Util.handleInlineValidation.call(this, formId, this, cloneUID, listIndex, valScr, "Equipments_address__length", true, true);
}
...
fc['validation_Provisioning_Data_location_Provisioning_Data_location__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getEquipments = function() {
			return this.form.dataMap['Equipments'].getValue();
		};
	}
...
tibcoforms.formCode['_qPdJUPEiEeeJiLkPq4yokA']['defineValidations']();
