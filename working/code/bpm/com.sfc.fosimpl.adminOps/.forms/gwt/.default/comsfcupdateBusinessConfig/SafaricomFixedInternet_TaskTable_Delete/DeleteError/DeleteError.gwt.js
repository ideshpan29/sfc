...
tibcoforms.formCode['_BN7k4PjyEeej8uWuBC0YMQ'] = new Object();
tibcoforms.formCode['_BN7k4PjyEeej8uWuBC0YMQ']['defineActions'] = function() {
var fc = tibcoforms.formCode['_BN7k4PjyEeej8uWuBC0YMQ'];
...
tibcoforms.formCode['_BN7k4PjyEeej8uWuBC0YMQ']['defineActions']();

tibcoforms.formCode['_BN7k4PjyEeej8uWuBC0YMQ']['defineValidations'] = function() {
var fc = tibcoforms.formCode['_BN7k4PjyEeej8uWuBC0YMQ'];
...
fc['validation_DeleteCaseFailed_DeleteCaseFailed__length'] = function(formId, controlName, cloneUID, listIndex) {
	...
	fc['DataModel']=function(formId) {
		...
		this.getDeleteCaseFailed = function(useInternal) {
			return this.form.dataMap['DeleteCaseFailed'].getValue(useInternal);
		};
		this.setDeleteCaseFailed = function(value) {
			return this.form.dataMap['DeleteCaseFailed'].setValue(value);
		};
	}
...
tibcoforms.formCode['_BN7k4PjyEeej8uWuBC0YMQ']['defineValidations']();
