 ...
 * This provides an implementation of the class com.example.sfc_provisioningbom.SLA_Configuration. 
 */ 


com.tibco.data.Loader.classDefiner["com.example.sfc_provisioningbom.SLA_Configuration"] = function() {
...
theClass.LOADER.registerClass(theClass, "com.example.sfc_provisioningbom.SLA_Configuration");
...
theClass.TYPE_ARRAY[theClass.ATTR_ENABLEDISABLEFLAG] = {type:"com.example.sfc_provisioningbom.EnableDisable", baseType:"com.example.sfc_provisioningbom.EnableDisable", primitive:true, multivalued:false, required:false, defaultValue:""};
...
theClass.getName = function() {
    return "com.example.sfc_provisioningbom.SLA_Configuration";
};
...
theClass._getTypeDef = function(attName) {
	...
	if (attType == null)
		throw("Attribute " + attName + " not recognized for class com.example.sfc_provisioningbom.SLA_Configuration");
	return attType;
};

theClass.prototype.getClass  = function() {
    return this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration");
};

theClass.prototype.getSLALevel = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_SLALEVEL, useInternal);
};

theClass.prototype.setSLALevel = function(SLALevel) {
    this._setPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_SLALEVEL, SLALevel);
};


theClass.prototype.getTaskName = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_TASKNAME, useInternal);
};

theClass.prototype.setTaskName = function(taskName) {
    this._setPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_TASKNAME, taskName);
};


theClass.prototype.getProcessName = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_PROCESSNAME, useInternal);
};

theClass.prototype.setProcessName = function(processName) {
    this._setPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_PROCESSNAME, processName);
};


theClass.prototype.getSLA_Deadline = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_SLA_DEADLINE, useInternal);
};

theClass.prototype.setSLA_Deadline = function(SLA_Deadline) {
    this._setPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_SLA_DEADLINE, SLA_Deadline);
};


theClass.prototype.getEmailTo = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_EMAILTO, useInternal);
};

theClass.prototype.setEmailTo = function(emailTo) {
    this._setPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_EMAILTO, emailTo);
};


theClass.prototype.getTaskTo = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_TASKTO, useInternal);
};

theClass.prototype.setTaskTo = function(taskTo) {
    this._setPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_TASKTO, taskTo);
};


theClass.prototype.getEmailConfig = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_EMAILCONFIG, useInternal);
};

theClass.prototype.setEmailConfig = function(emailConfig) {
    this._setPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_EMAILCONFIG, emailConfig);
};


theClass.prototype.getTaskConfig = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_TASKCONFIG, useInternal);
};

theClass.prototype.setTaskConfig = function(taskConfig) {
    this._setPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_TASKCONFIG, taskConfig);
};


theClass.prototype.getEnableDisableFlag = function(useInternal) {
    return this._getPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_ENABLEDISABLEFLAG, useInternal);
};

theClass.prototype.setEnableDisableFlag = function(enableDisableFlag) {
    this._setPrimitiveAttribute(this.loader.getClass("com.example.sfc_provisioningbom.SLA_Configuration").ATTR_ENABLEDISABLEFLAG, enableDisableFlag);
};
...
com.tibco.data.Loader.classDefiner["com.example.sfc_provisioningbom.SLA_Configuration"]();
